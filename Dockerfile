...
FROM --platform=$BUILDPLATFORM ghcr.io/edera-dev/kernel-buildenv:latest@sha256:fc0aa61bd411d0274e70f18e9ca7ce8ca5f65001ed93aba29df1292cec1af36d AS buildenv
